...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'app_name': '360 Ghar',
      'loading': 'Loading...',
      'starting_app': 'Starting 360 Ghar...',
      'checking_session': 'Checking your session...',
      'boot_taking_longer':
          'This is taking longer than expected. Check your connection and try again.',
      'bootstrap_failed_title': 'Unable to start',
      'bootstrap_failed_message':
          'The app could not finish startup. Restart the app, or run with environment config:\n./tool/run_with_env.sh .env.development',
      'bootstrap_missing_config':
          'Missing SUPABASE_URL or SUPABASE_PUBLISHABLE_KEY. Pass them via --dart-define or run:\n./tool/run_with_env.sh .env.development',
      'bootstrap_timeout': 'Connecting to the server timed out. Check your network and try again.',
      'change': 'Change',
      ...
      'apply': 'Apply',
      'back': 'Back',
      'bedrooms_short': '@count BHK',
      'bathrooms_short': '@count Bath',
      'zoom_in': 'Zoom in',
      'zoom_out': 'Zoom out',
      'my_location': 'My location',
      'fit_map_to_properties': 'Fit map to properties',
      ...
      'more_amenities': '+@count more amenities',
      'show_less_amenities': 'Show less',
      ...
      'complete': 'Complete',
      // Error bodies surfaced by ErrorMapper. Titles were already localised;
      // these were hardcoded English, so a Hindi user saw a Hindi title over
      // an English body.
      'error_no_connection': 'Unable to reach the server. Please check your internet connection.',
      'error_timeout': 'The connection timed out. Please check your internet and try again.',
      'error_network_generic': 'A network error occurred. Please try again.',
      'error_bad_request': 'Invalid request. Please check your input and try again.',
      'error_forbidden': "You don't have permission to access this.",
      'error_not_found_body': 'We could not find what you were looking for.',
      'error_method_not_allowed': 'This action is not supported. Please try something else.',
      'error_validation_body': 'Please check your input and try again.',
      'error_server_500': 'A server error occurred. Our team has been notified.',
      'error_server_unavailable': 'The server is temporarily unavailable. Please try again later.',
      'error_server_generic': 'Something went wrong on the server. Please try again.',
      // Indian currency magnitude suffixes (see IndianCurrency).
      'swipe_not_saved': 'One of your swipes could not be saved.',
      'unit_crore': 'Cr',
      'unit_lakh': 'L',
      ...
      'swipe_save_failed': 'Your swipe could not be saved. The property is back in your deck.',
      ...
      'sale_date_must_be_after_purchase_date': 'Sale date must be on or after purchase date',
      'tenure_max_years': 'Tenure cannot exceed @years years',
      ...
      'assistant_tool_loading_my_properties': 'Loading your properties...',
      ...
      'password_min_chars': 'Password must be 8+ characters',
    ...
    'hi_IN': {
      ...
      'starting_app': '360 Ghar शुरू हो रहा है...',
      'checking_session': 'आपका सत्र जाँचा जा रहा है...',
      'boot_taking_longer':
          'इसमें सामान्य से अधिक समय लग रहा है। अपना कनेक्शन जाँचें और फिर कोशिश करें।',
      'bootstrap_failed_title': 'ऐप शुरू नहीं हो सका',
      'bootstrap_failed_message':
          'ऐप स्टार्टअप पूरा नहीं कर सका। ऐप रीस्टार्ट करें, या env कॉन्फ़िग के साथ चलाएँ:\n./tool/run_with_env.sh .env.development',
      'bootstrap_missing_config':
          'SUPABASE_URL या SUPABASE_PUBLISHABLE_KEY गायब है। --dart-define से पास करें या चलाएँ:\n./tool/run_with_env.sh .env.development',
      'bootstrap_timeout':
          'सर्वर से कनेक्ट होने में समय समाप्त। अपना नेटवर्क जाँचें और फिर कोशिश करें।',
      ...
      'back': 'वापस',
      'bedrooms_short': '@count BHK',
      'bathrooms_short': '@count बाथरूम',
      'zoom_in': 'ज़ूम इन',
      'zoom_out': 'ज़ूम आउट',
      'my_location': 'मेरा स्थान',
      'fit_map_to_properties': 'प्रॉपर्टीज़ पर फ़िट करें',
      ...
      'stop_generating': 'जनरेट करना रोकें',
      ...
      'more_amenities': '+@count और सुविधाएँ',
      'show_less_amenities': 'कम दिखाएँ',
      'section_overview': 'अवलोकन',
      'section_media': 'मीडिया',
      'section_specs': 'विवरण',
      'section_location': 'स्थान',
      'directions': 'दिशा-निर्देश',
      'view_all_photos': 'सभी फ़ोटो देखें',
      'photos': 'फ़ोटो',
      ...
      'swipe_save_failed': 'आपका स्वाइप सेव नहीं हो सका। संपत्ति आपके डेक में वापस आ गई है।',
      ...
      'sale_date_must_be_after_purchase_date': 'बिक्री तिथि खरीद तिथि के बाद या उसी दिन होनी चाहिए',
      'tenure_max_years': 'अवधि @years वर्ष से अधिक नहीं हो सकती',
      ...
      'assistant_tool_loading_my_properties': 'आपकी संपत्तियाँ लोड हो रही हैं...',
      ...
      'password_min_chars': 'पासवर्ड 8+ अक्षर का होना चाहिए',
      ...
      // Auth entry, signup and profile completion. These existed only in
      // en_US, so the whole first-run flow fell back to English for Hindi
      // users despite the app being set to Hindi.
      'welcome_to_app': '360 घर में आपका स्वागत है',
      'enter_mobile_number': 'अपना मोबाइल नंबर दर्ज करें',
      'enter_mobile_to_continue': 'शुरू करने के लिए अपना मोबाइल नंबर दर्ज करें',
      'we_will_check_account': 'हम जांचेंगे कि आपका खाता है या नहीं',
      'checking_account': 'खाता जांचा जा रहा है...',
      'phone_not_found': 'इस नंबर से कोई खाता नहीं मिला',
      'create_new_account': 'नया खाता बनाएं',
      'enter_password_to_continue': 'जारी रखने के लिए अपना पासवर्ड दर्ज करें',
      'continue_btn': 'जारी रखें',
      'change': 'बदलें',
      'terms_footer': 'जारी रखकर, आप हमारे नियम और शर्तों से सहमत होते हैं',
      'tell_us_about_yourself': 'हमें अपने बारे में थोड़ा बताएं',
      'create_password': 'पासवर्ड बनाएं',
      'secure_your_account': 'एक मजबूत पासवर्ड से अपना खाता सुरक्षित करें',
      ...
      'personal_info_step': 'व्यक्तिगत जानकारी',
      'property_purpose': 'संपत्ति का उद्देश्य',
      // Error bodies surfaced by ErrorMapper (see the en_US block).
      'error_no_connection': 'सर्वर से संपर्क नहीं हो पा रहा। कृपया अपना इंटरनेट कनेक्शन जांचें।',
      'error_timeout': 'कनेक्शन का समय समाप्त हो गया। कृपया इंटरनेट जांचकर पुनः प्रयास करें।',
      'error_network_generic': 'नेटवर्क त्रुटि हुई। कृपया पुनः प्रयास करें।',
      'error_bad_request': 'अमान्य अनुरोध। कृपया अपनी जानकारी जांचकर पुनः प्रयास करें।',
      'error_forbidden': 'आपके पास इसे देखने की अनुमति नहीं है।',
      'error_not_found_body': 'आप जो खोज रहे थे वह नहीं मिला।',
      'error_method_not_allowed': 'यह कार्य समर्थित नहीं है। कृपया कुछ और आज़माएं।',
      'error_validation_body': 'कृपया अपनी जानकारी जांचकर पुनः प्रयास करें।',
      'error_server_500': 'सर्वर त्रुटि हुई। हमारी टीम को सूचित कर दिया गया है।',
      'error_server_unavailable':
          'सर्वर अस्थायी रूप से अनुपलब्ध है। कृपया बाद में पुनः प्रयास करें।',
      'error_server_generic': 'सर्वर पर कुछ गलत हो गया। कृपया पुनः प्रयास करें।',
      // Indian currency magnitude suffixes (see IndianCurrency).
      'swipe_not_saved': 'आपका एक स्वाइप सहेजा नहीं जा सका।',
      'unit_crore': 'करोड़',
      'unit_lakh': 'लाख',
      'security_step': 'पासवर्ड बनाएं',
      'verify_step': 'फोन सत्यापित करें',
    },
  };
}
